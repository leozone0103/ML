...
class F1(Module):
    ...
    def __init__(self, h: int, d: int, k: int):
        ...
        super().__init__()
        alpha = 1 / math.sqrt(d)
        self.weight_1 = Parameter(torch.rand((d, h), requires_grad=True))
        self.bias_1 = Parameter(torch.rand(h, requires_grad=True))
        self.weight_2 = Parameter(torch.rand((h, k), requires_grad=True))
        self.bias_2 = Parameter(torch.rand(k, requires_grad=True))
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        """
        l1 = x @ self.weight_1 + self.bias_1
        l1[l1 <= 0] = 0
        return l1 @ self.weight_2 + self.bias_2
...
class F2(Module):
    ...
    def __init__(self, h0: int, h1: int, d: int, k: int):
        ...
        super().__init__()
        alpha = 1 / math.sqrt(d)
        self.weight_1 = Parameter(torch.rand((d, h0), requires_grad=True))
        self.bias_1 = Parameter(torch.rand(h0, requires_grad=True))
        self.weight_2 = Parameter(torch.rand((h0, h1), requires_grad=True))
        self.bias_2 = Parameter(torch.rand(h1, requires_grad=True))
        self.weight_3 = Parameter(torch.rand((h1, k), requires_grad=True))
        self.bias_3 = Parameter(torch.rand(k, requires_grad=True))
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        l1 = x @ self.weight_1 + self.bias_1
        l1[l1 <= 0] = 0
        l2 = l1 @ self.weight_2 + self.bias_2
        l2[l2 <= 0] = 0
        return l2 @ self.weight_3 + self.bias_3
